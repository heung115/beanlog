      ...
      <div className={cn("flex flex-col gap-1.5", className)}>
        ...
        <div className="relative">
          <input
            ...
            className={cn(
              "w-full rounded-md border border-border bg-surface px-3 py-2.5 pr-9 text-sm text-brown placeholder:text-brown-light/40",
          ...
          {showList && (
            <ul
              ...
              className="absolute z-20 mt-1 max-h-60 w-full min-w-72 overflow-y-auto rounded-md border border-border bg-surface py-1 shadow-lg"
            >
