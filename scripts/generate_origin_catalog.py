...
from origin_contact import minimize_entity

# Keep the sanitizer and fixture scanner usable without spreadsheet dependencies.
...
-- Contact-bearing segments are removed before SQL generation; source identifiers are retained.
